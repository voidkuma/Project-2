...
bool CXMLReader::ReadEntity(SXMLEntity &entity, bool skipcdata) 
{
    ...
    while (DImplementation->Source->Get(c)) 
    {
        ...
        {  
            ...
            {  // if the last character is forward slash
            ...
            {   
                ...
                // go through each element in and find the first space in the tag 
                ...
                if (position != std::string::npos) 
                {
                    ...
                    //go thorugh elements after the first space until we find an equals
                    ...
                    while ((pos = attributes.find('=')) != std::string::npos) 
                    {
                        ...
                        if (quotePos != std::string::npos) 
                        {
                            ...
                            //find the index after the next uote
                            if (quotePos != std::string::npos) 
                            {
